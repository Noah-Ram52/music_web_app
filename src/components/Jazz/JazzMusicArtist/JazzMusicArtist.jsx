...
function JazzMusicArtist() {
    ...
    return (    
        ...
        thirdJazzArtist={jazzArtistImages[2]}
        fourthJazzArtist={jazzArtistImages[3]}
        fifthJazzArtist={jazzArtistImages[4]}
        firstJazzArtistName={jazzArtistsNames[0]}
        secondJazzArtistName={jazzArtistsNames[1]}
        thirdJazzArtistName={jazzArtistsNames[2]}
        fourthJazzArtistName={jazzArtistsNames[3]}
        fifthJazzArtistName={jazzArtistsNames[4]}
        firstJazzArtistInfo={jazzArtistInformation[0]}
